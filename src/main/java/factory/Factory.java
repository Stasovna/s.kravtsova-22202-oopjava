...
public class Factory {
    ...
    private final StorageProvider storageProvider = new StorageProvider(config);//отвечет за хранение
    ...
    public void start() {
        threadManager.startThreads();//запускаем потоки с теми кто заполняем склады
        controllerThread.start();
    }

    public void stop() {//останавливает
